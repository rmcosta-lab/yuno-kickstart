...
| `api/openapi.json`                                                                                                                 | Fase 16 API writer                                                         | Generate from tested FastAPI/Pydantic source; never hand-edit.                                                                            |
| `frontend/src/lib/api/generated/**`                                                                                                | Fase 16 frontend writer                                                    | Regenerate from the reviewed `api/openapi.json` checkpoint; never hand-edit.                                                              |
...
backend service symbols freeze before API and frontend work begin; each generated artifact has the
single writer assigned above.
